    ...
    return (
        <article className="flex items-center justify-center mx-auto p-4">
            <div className="relative w-full max-w-6xl bg-zinc-300 rounded-3xl flex flex-col md:flex-row items-center justify-between p-4 md:p-8">
                <div
                    className="z-10 text-indigo-950  text-2xl md:text-5xl font-bold font-['Volkhov'] leading-tight md:leading-12 mb-4 md:mb-0 md:pl-4"
                >
                    <p className="tracking-wide">“Al otro día te ponías ese uniforme de invencible y volvías a salir a luchar”</p>
                </div>
