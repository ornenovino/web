const Button = () => {
    return (
        <>
            <button
                type="button"
                className="rounded-full bg-primary p-3 text-xs font-medium uppercase leading-normal text-white shadow-lg transition duration-150 ease-in-out hover:bg-primary-700 focus:bg-primary-700 focus:outline-none focus:ring-0 active:bg-primary-800"
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div className="relative flex-auto p-4" data-te-modal-body-ref>...</div>
                        <div
